...
| 文件 | 用途 | 使用位置 |
|---|---|---|
| `附件1：小区基础数据.xlsx` | 人口结构和转移概率 | [q1_solution.py:L32-L53](../q1_solution.py#L32-L53) |
| `附件2：服务需求数据.xlsx` | 服务频次、价格、成本、消费上限 | [q1_solution.py:L56-L81](../q1_solution.py#L56-L81) |
...
| 文件 | 字段 | 生成位置 |
|---|---|---|
| `q1_output/year5_population.csv` | 小区、60岁以上人口、自理、半失能、失能 | [q1_solution.py:L162-L202](../q1_solution.py#L162-L202) |
| `q1_output/year5_actual_demand.csv` | 小区、老人类型、服务项目、消费约束缩放系数、实际月均需求次数 | [q1_solution.py:L110-L159](../q1_solution.py#L110-L159) |
