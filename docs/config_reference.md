...
|---|---|---|---|---|---|
| 附件1 B3 自理转半失能概率 | float | 0.045 | [q1_solution.py:L36-L57](../q1_solution.py#L36-L57) | 影响五年人口结构和所有后续需求 | `python q1_solution.py` |
| 附件1 B4 半失能转失能概率 | float | 0.1 | [q1_solution.py:L36-L57](../q1_solution.py#L36-L57) | 影响失能需求和护理/助浴需求 | `python q1_solution.py` |
